  ...
  return (
    <div className="min-h-screen bg-black">
      <main className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        {/* Header */}
        <Link href="/policies" className="mb-12 block text-neutral-400 hover:text-white transition-colors">
          ← Back to Policies
        </Link>

        {/* Title */}
        <h1 className="mb-4 text-4xl font-medium tracking-tight text-white md:text-5xl">
          LensCherry Terms of Service and Privacy Policy
        </h1>
        ...
        <div className="prose prose-invert prose-neutral max-w-none">
          <p className="text-lg leading-relaxed text-neutral-300 mb-8">
            PLEASE READ THESE TERMS OF SERVICE (&quot;AGREEMENT&quot; OR &quot;TERMS OF SERVICE&quot;) CAREFULLY BEFORE USING THE SERVICES OFFERED BY VESPERION GATE INC. THIS AGREEMENT SETS FORTH THE LEGALLY BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE VESPERION GATE INC. WEBSITE AND ALL RELATED SERVICES, INCLUDING, WITHOUT LIMITATION, ANY FEATURES, CONTENT, WEBSITES OR APPLICATIONS OFFERED FROM TIME TO TIME BY VESPERION GATE INC. IN CONNECTION THEREWITH (COLLECTIVELY &quot;SERVICE(S)&quot;). BY USING THE SERVICES IN ANY MANNER, YOU AGREE TO BE BOUND BY THIS AGREEMENT.
          </p>

          <p className="text-neutral-300 mb-8">
            &quot;The Site&quot; refers to the websites operated by Vesperion Gate Inc., as well as any associated applications, services, features, content, and functionalities offered by Vesperion Gate Inc.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Acceptance of Terms of Service</h2>
          <p className="text-neutral-300 mb-6">
            The Service is offered subject to acceptance without modification of all of these Terms of Service and all other operating rules, policies and procedures that may be published from time to time in connection with the Services by Vesperion Gate Inc. In addition, some services offered through the Service may be subject to additional terms and conditions promulgated by Vesperion Gate Inc. from time to time; your use of such services is subject to those additional terms and conditions, which are incorporated into these Terms of Service by this reference.
          </p>
          <p className="text-neutral-300 mb-6">
            Vesperion Gate Inc. may, in its sole discretion, refuse to offer the Service to any person or entity and change its eligibility criteria at any time. This provision is void where prohibited by law and the right to access the Service is revoked in such jurisdictions.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Rules and Conduct</h2>
          <p className="text-neutral-300 mb-6">
            By using Vesperion Gate Inc., you agree that the Service is intended solely for the purpose of creating AI models of yourself or other individuals for whom you have obtained explicit written consent. You acknowledge and agree that when creating AI models of other individuals, you must have their express written consent to use their photos and to create, train, and generate AI-generated images of them.
          </p>
          <p className="text-neutral-300 mb-6">
            By using Vesperion Gate Inc. to create an AI model, you confirm that you are creating a model of yourself and are over 18 years old (or the legal age in your country) and are not a politically exposed person, or you have obtained explicit written consent from any individual whose likeness you are using and confirm they are over 18 years old (or the legal age in their respective country, whichever is higher) and they are not a politically exposed person.
          </p>
          <p className="text-neutral-300 mb-6">
            By using the Vesperion Gate Inc. app, you agree that you are at least 18 years old or have reached the legal age of majority in your country of residence. If you are under 18 or the legal age in your country (whichever is higher), you are prohibited from using this app. It is your responsibility to ensure that you comply with your local laws regarding age restrictions for digital services.
          </p>
          <p className="text-neutral-300 mb-6">
            Vesperion Gate Inc.&apos;s video creation functionality is strictly for lawful and ethical purposes. By using the app, you agree NOT to create or distribute videos that: 1) Impersonate real individuals without their explicit consent, 2) Engage in or promote scams, fraud, or other misleading activities, 3) Promote or sell illegal products, services, or content, 4) Engage in political campaigning, advocacy, or misinformation, 5) Produce deepfake content with the intent to deceive, defraud, or mislead others, 6) Create content that violates privacy or portrays individuals in a harmful or false light, 7) Distribute violent, hateful, or discriminatory content of any kind, 8) Create false photography or documents to breach people&apos;s accounts. You agree to only use the video creation functionality for positive and lawful purposes, such as but not limited to: 1) Creating advertisements for legitimate products and services, 2) Marketing campaigns that promote legal and ethical businesses, 3) Explainer videos or tutorials to educate viewers, 4) Educational content for personal or commercial use, 5) Any other purpose that complies with applicable laws and this TOS.
          </p>
          <p className="text-neutral-300 mb-6">
          ...
          <p className="text-neutral-300 mb-6">
            Further, you shall not (directly or indirectly): (i) take any action that imposes or may impose an unreasonable or disproportionately large load on Vesperion Gate Inc.&apos;s (or its third party providers&apos;) infrastructure; (ii) interfere or attempt to interfere with the proper working of the Service or any activities conducted on the Service; (iii) bypass any measures Vesperion Gate Inc. may use to prevent or restrict access to the Service (or parts thereof); (iv) use any method to extract data from the Services, including web scraping, web harvesting, or web data extraction methods, other than as permitted through an allowable API; (v) reverse assemble, reverse compile, decompile, translate or otherwise attempt to discover the source code or underlying components of models, algorithms, and systems of the Services that are not open (except to the extent such restrictions are contrary to applicable law); and (vi) reproduce, duplicate, copy, sell, resell or exploit any portion of the Site, use of the Site, or access to the Site or any contact on the Site, without our express written permission.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">DMCA and Takedowns Policy</h2>
          <p className="text-neutral-300 mb-6">
            Vesperion Gate Inc. utilizes artificial intelligence systems to produce the Assets. Such Assets may be unintentionally similar to copyright protected material or trademarks held by others. We respect rights holders internationally and we ask our users to do the same.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Modification of Terms of Service</h2>
          <p className="text-neutral-300 mb-6">
            At its sole discretion, Vesperion Gate Inc. may modify or replace any of the Terms of Service, or change, suspend, or discontinue the Service (including without limitation, the availability of any feature, database, or content) at any time by posting a notice on the Vesperion Gate Inc. websites or Service or by sending you an email. Vesperion Gate Inc. may also impose limits on certain features and services or restrict your access to parts or all of the Service without notice or liability. It is your responsibility to check the Terms of Service periodically for changes. Your continued use of the Service following the posting of any changes to the Terms of Service constitutes acceptance of those changes.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Trademarks and Patents</h2>
          <p className="text-neutral-300 mb-6">
            All Vesperion Gate Inc. logos, marks and designations are trademarks or registered trademarks of Vesperion Gate Inc. All other trademarks mentioned in this website are the property of their respective owners. The trademarks and logos displayed on this website may not be used without the prior written consent of Vesperion Gate Inc. or their respective owners. Portions, features and/or functionality of Vesperion Gate Inc.&apos;s products may be protected under Vesperion Gate Inc. patent applications or patents.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Licensing Terms</h2>
          <p className="text-neutral-300 mb-6">
            Subject to your compliance with this Agreement, the conditions herein and any limitations applicable to Vesperion Gate Inc. or by law: (i) you are granted a non-exclusive, limited, non-transferable, non-sublicensable, non-assignable, freely revocable license to access and use the Service for business or personal use; (ii) you own all Assets you create with the Services and (iii) we hereby assign to you all rights, title and interest in and to such Assets for your personal or commercial use. Otherwise, Vesperion Gate Inc. reserves all rights not expressly granted under these Terms of Service. Each person must have a unique account and you are responsible for any activity conducted on your account. A breach or violation of any of our Terms of Service may result in an immediate termination of your right to use our Service.
          </p>
          <p className="text-neutral-300 mb-6">
            By using the Services, you grant to Vesperion Gate Inc., its successors, and assigns a perpetual, worldwide, non-exclusive, sublicensable, no-charge, royalty-free, irrevocable copyright license to use, copy, reproduce, process, adapt, modify, publish, transmit, prepare Derivative Works of, publicly display, publicly perform, sublicense, and/or distribute text prompts and images you input into the Services, or Assets produced by the Service at your direction. This license authorizes Vesperion Gate Inc. to make the Assets available generally and to use such Assets as needed to provide, maintain, promote and improve the Services, as well as to comply with applicable law and enforce our policies. You agree that this license is provided with no compensation paid to you by Vesperion Gate Inc. for your submission or creation of Assets, as the use of the Services by you is hereby agreed as being sufficient compensation for the grant of rights herein. You also grant each other user of the Service a worldwide, non-exclusive, royalty-free license to access your publicly available Assets through the Service, and to use those Assets (including to reproduce, distribute, modify, display, and perform it) only as enabled by a feature of the Service. The license to Vesperion Gate Inc. survives termination of this Agreement by any party, for any reason.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Fees and Payments</h2>
          <p className="text-neutral-300 mb-6">
            You agree that Vesperion Gate Inc. provides you immediate access to digital content and begins service consumption immediately upon purchase, without the standard 14-day withdrawal period. Therefore, you expressly waive your right to withdraw from this purchase. Due to the high costs of GPU processing, we&apos;re not able to offer refunds because we reserve servers and incur high costs for your usage immediately. The subscription will be automatically renewed for the same period of time after the agreed term. If you do not wish to renew your subscription in the end of the term, you should cancel prior to the renewal date of your subscription.
          </p>
          <p className="text-neutral-300 mb-6">
            Vesperion Gate Inc. offers a paid Service. You can sign up for a monthly or yearly subscription, that will automatically renew on a monthly or yearly basis. You can stop using the Service and cancel your subscription at any time through the website (click Billing). If you cancel your subscription, you will not receive a refund or credit for any amounts that have already been billed or paid. Vesperion Gate Inc. reserves the right to change its prices and offering (like credits or models) at any time. If you are on a subscription plan, changes to pricing will not apply until your next renewal.
          </p>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Termination</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Indemnification</h2>
          <p className="text-neutral-300 mb-6">
            You shall defend, indemnify, and hold harmless Vesperion Gate Inc., its affiliates and each of its, and its affiliates employees, contractors, directors, suppliers and representatives from all liabilities, losses, claims, and expenses, including reasonable attorneys&apos; fees, that arise from or relate to (i) your use or misuse of, or access to, the Service, or (ii) your violation of the Terms of Service or any applicable law, contract, policy, regulation or other obligation. Vesperion Gate Inc. reserves the right to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you will assist and cooperate with Vesperion Gate Inc. in connection therewith.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Limitation of Liability</h2>
          <p className="text-neutral-300 mb-6 uppercase">
            IN NO EVENT SHALL VESPERION GATE INC. OR ITS DIRECTORS, EMPLOYEES, AGENTS, PARTNERS, SUPPLIERS OR CONTENT PROVIDERS, BE LIABLE UNDER CONTRACT, TORT, STRICT LIABILITY, NEGLIGENCE OR ANY OTHER LEGAL OR EQUITABLE THEORY WITH RESPECT TO THE SERVICE (I) FOR ANY LOST PROFITS, DATA LOSS, COST OF PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, OR SPECIAL, INDIRECT, INCIDENTAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES OF ANY KIND WHATSOEVER, OR SUBSTITUTE GOODS OR SERVICES, (II) FOR YOUR RELIANCE ON THE SERVICE OR (III) FOR ANY DIRECT DAMAGES IN EXCESS (IN THE AGGREGATE) OF THE FEES PAID BY YOU FOR THE SERVICE OR, IF GREATER, $500. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE LIMITATIONS AND EXCLUSIONS MAY NOT APPLY TO YOU.
          </p>
          <p className="text-neutral-300 mb-6 uppercase">
            IN NO EVENT SHALL VESPERION GATE INC. OR ITS OWNERS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH USE OF THIS APPLICATION.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Disclaimer</h2>
          <p className="text-neutral-300 mb-6 uppercase">
            ALL USE OF THE SERVICE AND ANY CONTENT IS UNDERTAKEN ENTIRELY AT YOUR OWN RISK. THE SERVICE (INCLUDING, WITHOUT LIMITATION, THE VESPERION GATE INC. WEB APP AND ANY CONTENT) IS PROVIDED &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; AND IS WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE IMPLIED WARRANTIES OF TITLE, NON-INFRINGEMENT, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE, AND ANY WARRANTIES IMPLIED BY ANY COURSE OF PERFORMANCE OR USAGE OF TRADE, ALL OF WHICH ARE EXPRESSLY DISCLAIMED. SOME STATES DO NOT ALLOW LIMITATIONS ON HOW LONG AN IMPLIED WARRANTY LASTS, SO THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Age Requirements</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Miscellaneous</h2>
          <p className="text-neutral-300 mb-6">
            The Terms of Service are the entire agreement between you and Vesperion Gate Inc. with respect to the Service, and supersede all prior or contemporaneous communications and proposals (whether oral, written or electronic) between you and Vesperion Gate Inc. with respect to the Service. If any provision of the Terms of Service is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that the Terms of Service will otherwise remain in full force and effect and enforceable. The failure of either party to exercise in any respect any right provided for herein shall not be deemed a waiver of any further rights hereunder. Vesperion Gate Inc. shall not be liable for any failure to perform its obligations hereunder due to any cause beyond Vesperion Gate Inc.&apos;s reasonable control. The Terms of Service are personal to you, and are not assignable or transferable by you except with Vesperion Gate Inc.&apos;s prior written consent. Vesperion Gate Inc. may assign, transfer or delegate any of its rights and obligations hereunder without consent. No agency, partnership, joint venture, or employment relationship is created as a result of the Terms of Service and neither party has any authority of any kind to bind the other in any respect. Except as otherwise provided herein, all notices under the Terms of Service will be in writing and will be deemed to have been duly given when received, if personally delivered or sent by certified or registered mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or e-mail; or two days after it is sent, if sent for next day delivery by recognized overnight delivery service.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Contact Us</h2>
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Your Rights to Use the Site; Our Content and Intellectual Property Rights</h3>
          <p className="text-neutral-300 mb-6">
            Subject to these Terms, Vesperion Gate Inc. grants you a limited, non-exclusive, revocable, and personal license to access and use the Site solely for noncommercial and informational purposes.
          </p>
          <p className="text-neutral-300 mb-6">
            Unless otherwise expressly indicated by Vesperion Gate Inc., all content displayed or made available on the Site, including without limitation, text, images, illustrations, designs, logos, domain names, service marks, software, scripts, and the selection, compilation and arrangement of any of the foregoing is owned by Vesperion Gate Inc., its affiliates, licensors and/or other third parties (&quot;Site Content&quot;). The Site and all Site Content are protected by copyright, trade dress, trademark, moral rights, and other intellectual property laws in the United States, the United Kingdom, and other international jurisdictions. All such rights are reserved.
          </p>
          <p className="text-neutral-300 mb-6">
            All registered and unregistered trademarks, logos, and service marks are the property of Vesperion Gate Inc. and/or their respective owners. Nothing displayed or accessed in connection with the Site shall be construed as granting by implication, estoppel, or otherwise, any license or right to use any trademark, logo, or service mark displayed in connection with the Site without the owner&apos;s prior written permission, except as otherwise described herein.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Prohibited Uses</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">DMCA Copyright Infringement Notice</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Termination of Repeat Infringers</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Disclaimer</h2>
          <p className="text-neutral-300 mb-6 uppercase">
            THE SITE IS PROVIDED ON AN &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; BASIS. EXCEPT TO THE EXTENT PROHIBITED BY LAW, WE MAKE NO WARRANTIES (EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE) WITH RESPECT TO THE SITE OR THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND DISCLAIM ALL WARRANTIES, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. VESPERION GATE INC. MAKES NO WARRANTY THAT (A) THE SITE WILL MEET YOUR REQUIREMENTS, (B) ACCESS TO AND USE OF THE SITE WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE, AND (C) THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE SITE WILL BE ACCURATE OR RELIABLE.
          </p>
          <p className="text-neutral-300 mb-6">
            Vesperion Gate Inc. reserves the right in our sole discretion to modify or discontinue, temporarily or permanently, the Site (or any part thereof) with or without notice. You agree that Vesperion Gate Inc. will not be liable to you or to any third party for any modification or discontinuance of the Site, except as set forth in the &quot;Limitation of Liability&quot; section below.
          </p>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Limitation of Liability</h2>
          <p className="text-neutral-300 mb-6 uppercase">
            YOU EXPRESSLY UNDERSTAND AND AGREE THAT NEITHER VESPERION GATE INC. NOR ITS OFFICERS, EMPLOYEES, DIRECTORS, SHAREHOLDERS, LICENSORS, SERVICE PROVIDERS, AND AGENTS WILL BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, EXEMPLARY DAMAGES, OR DAMAGES FOR LOSS OF PROFITS INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF VESPERION GATE INC. HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), WHETHER BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, RESULTING FROM: (A) THE USE OR THE INABILITY TO USE THE SITE OR ANY RELATED INFORMATION; (B) CONDUCT OF ANY THIRD PARTY (INCLUDING OTHER USERS) OF THE SITE; OR (C) ANY OTHER MATTER RELATING TO THE SITE. IN NO EVENT WILL VESPERION GATE INC.&apos;S TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES OR CAUSES OF ACTION EXCEED ONE HUNDRED DOLLARS ($100). IF YOU ARE MERELY DISSATISFIED WITH ANY PORTION OF THE SITE OR WITH THESE TERMS, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE THE USE OF THE SITE.
          </p>
          <p className="text-neutral-300 mb-6 uppercase">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Prohibition of Class and Representative Actions and Non-Individualised Relief</h3>
          <p className="text-neutral-300 mb-6 uppercase">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Cost of Arbitration</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Opt Out</h3>
          <p className="text-neutral-300 mb-6">
            You may reject this Arbitration Agreement, in which case only a court may be used to resolve any Claim. To reject this provision, you must send us an opt-out notice (the &quot;Opt Out&quot;) within thirty (30) days after you first access the Site. The Opt-Out must be sent to the Vesperion Gate Inc. Notice Address. The Opt-Out must include your name, phone number and the email address you used to sign up and use the Site. This is the only way of opting out of this Arbitration Agreement. Opting out will not affect any other aspect of these Terms and will have no effect on any other or future agreements you may reach to arbitrate with us.
          </p>

          <h3 className="text-xl font-medium text-white mt-8 mb-4">Severability</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Waiver and Severability</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Entire Agreement; Construction</h2>
          <p className="text-neutral-300 mb-6">
            These Terms contain the entire agreement between you and Vesperion Gate Inc. regarding your use of the Site and supersede any prior or contemporaneous agreements, communications, or understandings between you and Vesperion Gate Inc. on that subject.
          </p>

          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Assignment and Delegation</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Changes to these Terms</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-medium text-white mt-12 mb-6">Privacy</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Information Use</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Information Sharing</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Information Protection</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Other Information</h3>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">European Economic Area, United Kingdom, Swiss and California users</h3>
          <p className="text-neutral-300 mb-6">
            The following rights are granted under the European General Data Protection Regulation (&quot;GDPR&quot;) and California Consumer Privacy Act (&quot;CCPA&quot;). Vesperion Gate Inc. applies these rights to all users of our products, regardless of your location: The right to know what personal information is collected. The right to know if personal information is being shared, and to whom. The right to access your personal information. The right to exercise your privacy rights without being discriminated against.
          </p>
          <p className="text-neutral-300 mb-6">
            EEA, UK, and Swiss Users: Our lawful bases for collecting and processing personal information under the GDPR include: Performing our contract with you and providing our services. Legitimate interests: we receive technical and interaction data of users, which may include IP addresses, to improve the security and reliability of our services and prevent abuse, and to understand where people learn about Vesperion Gate Inc. Consent: where we ask for your consent to process your information, you can always withdraw this consent.
          </p>
          <p className="text-neutral-300 mb-6">
          ...
          <h3 className="text-xl font-medium text-white mt-8 mb-4">Changes</h3>
          <p className="text-neutral-300 mb-6">
        ...
        <footer className="mt-20 text-center">
          <Link href="/policies" className="text-neutral-400 hover:text-white transition-colors">
            ← Back to Policies
          </Link>
        </footer>
      </main>
